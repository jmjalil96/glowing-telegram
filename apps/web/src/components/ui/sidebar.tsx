...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-6 z-30 hidden size-7 items-center justify-center rounded-full border border-sidebar-border bg-background text-foreground shadow-sm transition-all ease-linear hover:bg-accent hover:text-accent-foreground focus-visible:ring-2 focus-visible:ring-ring/40 sm:flex",
        "group-data-[side=left]:-right-3 group-data-[side=right]:-left-3",
        "[[data-side=left][data-state=collapsed]_&]:-right-9 [[data-side=right][data-state=collapsed]_&]:-left-9",
        className,
      )}
      {...props}
    >
